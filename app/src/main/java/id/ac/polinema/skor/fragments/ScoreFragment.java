	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		getParentFragmentManager().setFragmentResultListener(HOME_REQUEST_KEY, this, new FragmentResultListener() {
			...
			public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
				...
				binding.textHomeScorer.setText(getScores(homeGoalScorerList, HOME_REQUEST_KEY));
			}
		});
		getParentFragmentManager().setFragmentResultListener(AWAY_REQUEST_KEY, this, new FragmentResultListener() {
			...
			public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
				...
				binding.textAwayScorer.setText(getScores(awayGoalScorerList, AWAY_REQUEST_KEY));
			}
		});
		return binding.getRoot();
	}

	public String getScores(List list, String key) {
		String str = "";
		Iterator iter = null;
